      ...
      <div className="p-4 text-sm ">
        <div className="grid lg:flex gap-8 align-center py-4">
          ...
          <p className="text-xs font-semibold">
            A Hypetech é o último grito em entretenimento de jogo para
            uma nova geração de jogadores. Poderá ganhar várias vezes
            essa quantia em apenas alguns segundos! Nossos Jogos Turbo
            baseiam-se em uma forma que pode ser verificado no momento
            e é considerado como a única garantia real de
            funcionamento de justiça na indústria do jogo.
          </p>
        </div>
        <hr />
        <div className="p-3">
          <div className="grid lg:grid-cols-2 gap-12 mb-8 mx-auto">
            <div className="image-step sm:w-[60%] md:w-[45%] lg:w-[85%]  lg:h-[230px] h-[280px] mx-auto">
              <img
                className="step-image mx-auto w-full h-[100%] lg:h-[73%] md:h-[78%] sm:h-[80%]"
              ...
              >
                <p
                  ...
                  style={{ lineHeight: '2' }}
                >
                  Digite o valor desejado e selecione a tendência que
                  quer apostar, após, clique em REALIZAR ENTRADA.
                </p>
              </div>
            </div>
            <div className="image-step sm:w-[60%] md:w-[45%] lg:w-[85%]  lg:h-[230px] h-[280px] mx-auto">
              <img
                className="step-image mx-auto w-full h-[80%] lg:h-[73%] md:h-[78%] sm:h-[80%]"
          ...
          <p className="text-xs font-light">
            No entanto, não se esqueça que tem um limite de tempo. Tem
            de se fazer a aposta apenas durante a fase de apostas.
            Jogar <b>Wall Street Bull</b> é puro jogo de azar! É aqui
          ...
          <li className="list">
            A aposta automática pode ser ativada no painel de qualquer
            aposta ao clicar na aba <b>Auto</b> no canto superior
            esquerdo da tela. Para usar este modo, você deve definir
            no painel de apostas a face que você acredita que irá sair
            e quantas vezes deseja repetir esta jogada no campo
            "Quantidade", e então, iniciar o jogo automático clicando
            em "INICIAR ENTRADA AUTO".
          </li>
          ...
          <li className="list">
            O painel <b>"LANCES ANTERIORES"</b> que ha abaixo da tela
            do jogo (ou acima na versão mobile) contém informações
            sobre os últimos resultados que saíram durante os últimos
            jogos.
          </li>

          <li className="list">
            Abaixo do painel do jogo existe o painel "APOSTAS AO VIVO"
            onde mostra as apostas que foram feitas na rodada atual.
          </li>
          ...
          <li className="list">
            ...
            confiscados. Entretanto, as apostas serão reembolsadas na
            íntegra aos jogadores afetados no prazo de 1 hora.
          </li>
        </div>
      </div>
    </Modal>
