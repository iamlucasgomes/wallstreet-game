...
import ChatMaintenanceNotice from '../chatMaintenanceNotice'
type Props = {
  show: boolean
}

export const Chat = ({ show }: Props) => {
  const { messages, sendMessage, session } = useContext(
            ...
            <div className="form-control">
              <div className="input-group">
                <button
                  ...
                  onClick={(e: any) => handleShowEmojiPicker(e)}
                >
